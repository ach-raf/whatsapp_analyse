...
from dataWhatsapp import thread_parse
...
class GroupChat:
    ...
    def __init__(self, master_list):
        ...
        for user in self.users:
            try:
                temp_st = ''.join(map(lambda x: x[0], user.split(' ')))
                self.users_initials.append(temp_st)
            except Exception as e:
                self.users_initials.append('Unknown user')
                print('Unknown user', str(e))
    ...
    def message_rank(self):
        """
        print(s the total message counts for each user
        """
    ...
    def time_plot(self, bin_size=1, window=30):
        ...
        try:
            ...
            print('error at line 224 main.py ', e)
        ...
        try:
            ...
            print("error line 232 main.py", e)
    ...
    def message_length_plot(self):
        ...
        fig.savefig('./result/{0}/{0}_plots/Message_Length'.format(subject))
    ...
    def messages_plot(self):
        ...
        img.save('./result/{0}/{0}_plots/Messages.png'.format(subject))
